...
Parametry można podawać w dowolnej kolejności. Ostatnie 5 parametró jest opcjonalne - ich domyślne wartości to: pageSize = 100, key = 47, relationType = NonStrict, method = T, write = true. Spacje w nazwach plików nie są dopuszczalne.\\
