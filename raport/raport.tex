...
\item Istnieje wiele obiektów o różnych zestawach atrybutów należących do tej samej klasy. Jest to niejako implikacja pierwszego założenia, obiekty należące do jednej klasy z pewnością mają jakieś cechy wspólne, ale mogą się też różnić na poziomie jednego lub wielu atrybutów. \\
...
Obliczenia przeprowadzone dla całego zbioru są więc wykonywane na blisko $3*10^6$ elementów w której każdy obiekt posiada 42 atrybuty. Charakterystyka zbioru jest na tyle niesprzyjająca, że w kolejnych iteracjach bardzo mało wyników jest odrzucanych, poprawnie klasyfikowanych lub uznawanych za generator. Z tego powodu, pełnych wyników nie udało się wygenerować i nie będą tutaj zaprezentowane. W załączeniu, znajdują się wyniki dla podzbioru omawianego zbioru (100 obiektów). W tabeli poniżej zaprezentowane są wyniki ilościowe dla obliczeń przeprowadzonych dla całego zbioru.\\

\begin{tabular}{|r|r|r|r|r|r|}
\hline
Długość & Znalezionych & Do analizy & Odrzuconych & Czas generowania & Czas analizy \\ \hline
1 & 2 & 40 & 0 & - & 00:00:06.2461883 \\ \hline 
2 & 53 & 727 & 0 & 00:00:00.0057275 & 00:00:54.9421531 \\ \hline
3 & 4 & 7936 & 0 & 00:00:00.1198564 & 00:03:52.1625432 \\ \hline
4 & 16 & 57900 & 8 & 00:00:01.1161032 & 00:12:07.2952783 \\ \hline
5 & 138 & 296827 & 89 & 00:00:08.9237205 & 00:26:49.7468190 \\ \hline
6 & 358 & 1091632 & 319 & 00:01:21.4886054 & 00:42:31.4761249 \\ \hline
7 & 402 & 2878263 & 529 & 00:12:19.8936008 & 00:46:40.8668873 \\ \hline
8 & - & - & - & 00:38:55.9463328 & - \\ \hline
\end{tabular}

Zawrtość tabeli należy interpretować w następujący sposób: kandydaci o długości 3 zostali wygenerowani w czasie 120ms, wygenerowano łącznie 7900 takich kandydatów, z czego 4 zostały uznane za minimalne wzorce. Analiza kandydatów długości 3 trwała 3minuty 52 sekundy.\\

Uzyskane czasy wydają się być akceptowalne. W ostatnim, wierszu brak jest danych o uzyskanych rezultatach.\\

\subsection{Wyniki dla fragmentu zbioru cars}

Znalezione wzorce znajdują się w załączonym pliku. Ogółem dla podzbioru liczącego 100 losowo wybranych obiektów znaleziono 1102 minimalne wzorce. Dużą część wyników stanowią wzorce nie wspierane w zbiorze (ich obecność wynika z definicji, ale wzorce nie mają istotnego znaczenia praktycznego). Znalezionych wzorców tego rodzaju jest ok. 300. Wśród pozostałych wzorców ciekawym wnioskiem wydaje się fakt, że poprzedniki preferencji tworzą w pliku z wynikami grupy - dzięki temu w prosty sposób widać cechy które są najmniej preferowane.

\section{Wnioski}

\begin{enumerate}

\item Mimo, że w implementacji algorytmu dominującą operacją jest wyszukiwanie wspieranych przez transakcję kandydatów, okazuje się, że również generowanie kolejnej generacji kandydatów jest kosztowne obliczeniowo i należy poświęcić uwagę, na możliwie wydajne zaimplementowanie tego fragmentu kodu. Wydaje się, że warto do odnajdywania wszystkich elementów o (k-1) wspólnych wartości dla pewnego zbioru wykorzystać drzewo mieszające.
...
W kroku pierwszym\ref{krok1} należy wybrać pliki z danymi, klikając w przyciski Wybierz. Pliki wybiera się wykorzystując standardowy dialog wyboru plików z systemu Windows. Nie ma ograniczenia na rozszerzenie pliku.\\
