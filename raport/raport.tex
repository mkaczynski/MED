...
Złożoność tego fragmentu kodu w implementacji w przypadku pesymistycznym wynosi $\fraq{O(n^2)}{2}$ i okazuje się istotnym problemem przy budowaniu generacji kandydatów ze zbioru liczącego od kilkudziesięciu tysięcy do kilkuset tysięcy elementów.
